...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [_alt CreatAlt:nil circleName:getcell.cellDesc altTitle:getcell.creator Content:contentWithBlanck altButton:nil altbtnTcolor:[UIColor blackColor] altselectbtnTcolor:[UIColor whiteColor] icon:getcell.cellImage creator_id:getcell.creator_id circle_ID:getcell.ID virtual_id:getcell.virtual_cid ];
        _alt.view.sd_layout
